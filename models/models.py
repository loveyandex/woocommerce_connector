    ...
    def sync_woocommerce(self, vals):
        ...
        for data in jsonObject:
            ...
            vals= {
                    ...
                    'type': "consu",
                    'categ_id': 2,
                    'barcode': data['id'], # this is the unique ID of a product of woocommerce
                }
        ...
        for obj in existing_customers:
            ids_arr.append(obj['customer_id'])
        ids = ''
        if len(ids_arr) == 0:
            ids = ''
        else:
        ...
        response = requests.get(config_data['con_url'] + config_data['con_endpoint'] + 
                    "customers?consumer_key=" + config_data['consumer_key'] +"&consumer_secret=" + 
                        ...
                        # config_data['consumer_secret']+ "&role=all")
        jsonObject = response.json()
        ...
        for data in jsonObject:
            ...
            vals= {
                ...
                'date_order': "2020-04-01 16:20:29",# data['date_created'], 
